/**
 * AppUploadScreen.jsx — pre-capture screens for App.jsx.
 *
 * Renders either:
 *   - Drop-zone / spinner upload screen  (visualize=false, default)
 *   - Standalone Visualize page          (visualize=true)
 *
...
export default function AppUploadScreen({
  visualize,
  loading, loadMsg,
