...
used across the backend. Import from here, not from workspaces.network.parser.protocols.ports or
research.__init__.

Usage:
    from workspaces.network.constants import PROTOCOL_COLORS, WELL_KNOWN_PORTS, TCP_FLAG_BITS
    from workspaces.network.constants import ICMP_TYPES, CIPHER_SUITES, SWIFTEYE_LAYOUT
"""
